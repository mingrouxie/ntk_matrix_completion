...
# 1 Mar 23
PRIOR_DIR=/home/mrx/projects/affinity_pool/ntk_matrix_completion/data/priors/230301_hyp_osdas_omar

echo 'Creating 230301_hyp_osdas_omar prior file' 
...
# 1 Mar 23
PRIOR_DIR=/home/mrx/projects/affinity_pool/ntk_matrix_completion/data/priors/230301_hyp_osdas_others

echo 'Creating 230301_hyp_osdas_others prior file' 
FP_NAMES=(box axes whim getaway mol_weight mol_volume asphericity eccentricity inertial_shape_factor spherocity_index gyration_radius pmi1 pmi2 pmi3 npr1 npr2 free_sasa bertz_ct num_rot_bonds num_bonds formal_charge)
...
# # 1 Mar 23
# PRIOR_DIR=/home/mrx/projects/affinity_pool/ntk_matrix_completion/data/priors/230301_apriori

# echo 'Creating 230301_apriori prior file' 
# FP_NAMES=(box axes whim getaway mol_weight mol_volume asphericity eccentricity inertial_shape_factor spherocity_index gyration_radius pmi1 pmi2 pmi3 npr1 npr2 free_sasa bertz_ct num_rot_bonds num_bonds formal_charge)
...
# # 1 Mar 23
# PRIOR_DIR=/home/mrx/projects/affinity_pool/ntk_matrix_completion/data/priors/230301_apriori_lit

# echo 'Creating 230301_apriori prior file' 
# FP_NAMES=(box axes whim getaway mol_weight mol_volume asphericity eccentricity inertial_shape_factor spherocity_index gyration_radius pmi1 pmi2 pmi3 npr1 npr2 free_sasa bertz_ct num_rot_bonds num_bonds formal_charge)

# python ntk_matrix_completion/features/create_prior_file.py --op $PRIOR_DIR --features "${FP_NAMES[@]}" --osda --batch_size 10000 --exc 1 --ms 2021_apriori_dskoda literature
