...
# 7 Feb 2023
OP=/home/mrx/projects/affinity_pool/matrix_completion_analysis/kfi_screen
IK_FILE=$OP/analysis14_combined_iks.json
FWS_FILE=$OP/analysis14_fws.json
...
# python /home/mrx/projects/affinity/ntk_matrix_completion/features/create_prior_file.py --op $OP --features "${FP_NAMES[@]}" --osda --batch_size 10000 --ik_file $IK_FILE

python /home/mrx/projects/affinity/ntk_matrix_completion/features/create_prior_file.py --op $OP --batch_size 10000 --fws_file $FWS_FILE --zeolite
