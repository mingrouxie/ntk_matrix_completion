...
# MODEL="${ROOT}/output/2022_IZC/xgb_with_nb_hyperopt_2022107_91611/xgboost.json" # struct&struct
# # MODEL="${ROOT}/output/2022_IZC/xgb_with_nb_hyperopt_2022108_223835/xgboost.json" # getaway&struct why was I using this???
