#!/bin/bash
#SBATCH --job-name=run_10_6
#SBATCH --output=run_10_6_%j.log 
#SBATCH --partition=sched_mit_rafagb
#SBATCH --time=48:00:00                  # hh:mm:ss, alternatively 1-00:00 dd-hh:mm
...
python $SRC/models/multitask/train.py --config $SRC/run_scripts/expts/230131_mt/run_10_6/run_10.yml
