#!/bin/bash
#SBATCH --job-name=run_9
#SBATCH --output=run_9_%j.log 
#SBATCH --partition=sched_mit_rafagb
#SBATCH --time=72:00:00                  # hh:mm:ss, alternatively 1-00:00 dd-hh:mm
...
python $SRC/models/multitask/train.py --config $SRC/run_scripts/expts/230131_mt/run_9/run_9.yml
