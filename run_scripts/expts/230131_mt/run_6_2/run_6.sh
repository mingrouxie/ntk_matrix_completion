#!/bin/bash
#SBATCH --job-name=run_6_2
#SBATCH --output=run_6_2_%j.log 
#SBATCH --partition=sched_mit_rafagb
#SBATCH --time=40:00:00                  # hh:mm:ss, alternatively 1-00:00 dd-hh:mm
...
python $SRC/models/multitask/train.py --config $SRC/run_scripts/expts/230131_mt/run_6_2/run_6.yml
