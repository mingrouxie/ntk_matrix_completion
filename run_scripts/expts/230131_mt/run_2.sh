...
echo 'Experiment with multitasksep and prior_treatment: 3, structural features'

python $SRC/models/multitask/train.py --config $SRC/run_scripts/expts/230131_mt/run_2.yml
