#!/bin/bash
#SBATCH --job-name=230103_xgb_1
#SBATCH --output=230103_xgb_1_%j.log 
...
python models/xgboost/xgb.py --output $OUTPUT --prior_method "CustomOSDAandZeoliteAsRows" --osda_prior_file $OSDA_PRIOR_FILE --zeolite_prior_file $ZEO_PRIOR_FILE --sieved_file $OSDA_PRIOR_FILE --prior_treatment 3 --truth $TRUTH --mask $MASK  --osda_prior_map $OSDA_PRIOR_MAP --zeolite_prior_map $ZEO_PRIOR_MAP --input_scaler minmax --tune
