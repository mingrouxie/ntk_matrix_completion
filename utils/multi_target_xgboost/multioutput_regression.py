"""
XGBoost as of v1.6 has support for multioutput although with limited support for objectives and metrics
Copied from https://github.com/dmlc/xgboost/blob/master/demo/guide-python/multioutput_regression.py
Referencing https://xgboost.readthedocs.io/en/stable/tutorials/multioutput.html 

Github shows last updated March 2022
