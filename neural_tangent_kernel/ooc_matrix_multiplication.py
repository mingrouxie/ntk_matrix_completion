...
Taken from https://groups.google.com/g/pytables-users/c/pCgp-vyP4Zk?pli=1
"""
...
def ooc_dot(a, b, out=None):
    ...
    if out:
        ...
        out = f.create_carray(f.root, "out", atom, shape=(l, n), filters=filters)
...
if __name__ == "__main__":
    ...
    bd[:] = b
    cd = f.create_carray(f.root, "c", tb.Float64Atom(), (l, n), filters=filters)
