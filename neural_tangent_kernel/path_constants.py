...
PERSISTENCE_ZEOLITE_PRIOR_FILE = "data/nick_persistent/numeric_zeolite.pkl"
...
OSDA_HYPOTHETICAL_PREDICTED_ENERGIES = (
    "data/output/predicted_templating_energies_for_78K_OSDAs.pkl"
)
ZEOLITE_HYPOTHETICAL_PREDICTED_ENERGIES = (
    "data/output/predicted_binding_energies_for_zeo1.pkl"
)
